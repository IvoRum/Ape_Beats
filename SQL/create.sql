...
ALTER TABLE
    Instrument_istrument_type ADD CONSTRAINT instrument_istrument_type_instrument_type_id_foreign FOREIGN KEY(instrument_type_id) REFERENCES Instrument_type(id);
ALTER TABLE
...
ALTER TABLE
    Worker ADD CONSTRAINT worker_user_id_foreign FOREIGN KEY(ape_user) REFERENCES Ape_user(id);
ALTER TABLE
...
ALTER TABLE
    Client ADD CONSTRAINT client_user_id_foreign FOREIGN KEY(ape_user) REFERENCES Ape_user(id);
ALTER TABLE
    Item ADD CONSTRAINT item_genre_foreign FOREIGN KEY(genre) REFERENCES Genre(id);
ALTER TABLE
    Sale ADD CONSTRAINT sale_user_foreign FOREIGN KEY(ape_user) REFERENCES Ape_user(id);
ALTER TABLE
